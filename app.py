...
st.write('Proyecto	: Mi Primera Aplicación en Streamlit')
st.write('Alumno	: Ing. Alfonso Vicente Guevara Toscano')
st.write('Facilitador	: Carlos Carrillo, Mgtr.     Periodo	: 2024 - 2025')
st.divider()
#
